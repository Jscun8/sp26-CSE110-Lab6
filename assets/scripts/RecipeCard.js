...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		// Insert all of the styles from cardTemplate.html into the <style> element you just made (copy everything INSIDE the <style> tag>)
		style.textContent = ` 
			* {
	...
	set data(data) {
		...
		const ratingValue = Math.round(data.rating)
		article.innerHTML =   `
			<img src="${data.imgSrc}"
    			alt="${data.imgAlt}">
  			<p class="title">
  			...
  			<div class="rating">
    			...
    			<img src="/assets/images/icons/${ratingValue}-star.svg" alt="${ratingValue} stars">
